...
## RULE: Generated Tests
MANDATORY: All newly generated tests MUST be marked with the **refactoring** 
marker, using the appropriate framework-native markers (e.g., @pytest.mark.refactoring in Python).
